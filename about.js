document.addEventListener('DOMContentLoaded', function() {
    ...
    addButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const itemTitle = galleryItem.querySelector('.gallery-item-title').textContent;
    ...
    function expandCard(card, title) {
        ...
        const cardContents = {
            'Fluid Curiosity': 'From psychology to design, I explore, connect, and rethink ideas with curiosity and creativity',
            'Fast Learner': 'I have taught myself languages, design, and psychology—I never stop learning and improving.',
            'Fluent in People': 'Helping students of different ages and cultures learn Arabic strengthened my ability to create user-centered, accessible designs.',
            'Empath by Nature': 'Understanding struggles and finding solutions has been second nature to me since childhood.'
        };
    ...
    document.addEventListener('click', function(e) {
        if (!e.target.closest('.gallery-item') && !e.target.closest('.add-button')) {
            document.querySelectorAll('.gallery-item.expanded').forEach(item => {
                collapseCard(item);
            });
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function adjustBorderHeight() {
      skillCategories.forEach((category) => {
        ...
        const contentHeight = category.querySelector('.category-name').offsetHeight + 
