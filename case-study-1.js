document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.case-study-hero .animate-on-scroll').forEach(el => {
...
function updateOnThisPageContainer() {
    ...
    if (heroSection && overviewSection) {
        ...
        if (scrollPosition < heroBottom - 50) { // subtract a small offset for better transition
...
// Make sure to call this function on load and scroll
window.addEventListener('scroll', updateOnThisPageContainer);
document.addEventListener('DOMContentLoaded', updateOnThisPageContainer);
...
const sectionHeight = contentWidth * imgRatio;        
        ...
        for (let i = 0; i < totalSections * 2; i++) { // Double the sections for smooth scrolling
